...
# Коэффициент трения (0.85 = сохраняется 85% скорости, 15% теряется)
FRICTION = 0.85
MAX_VELOCITY = 2.0  # максимальная скорость
# Сила изменения скорости (чем больше, тем быстрее меняется направление)
